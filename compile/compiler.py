        ...
        if item.component_type in {"SPRING_BONE", "BONE_CHAIN"}:
            ...
            compiled.spring_bones.append(
                CompiledSpringBone(
                    ...
                    use_spring=bool(typed_item.use_spring),
                    spring_power=float(typed_item.spring_power),
                    limit_distance=float(typed_item.limit_distance),
                    normal_limit_ratio=float(typed_item.normal_limit_ratio),
                    spring_noise=float(typed_item.spring_noise),
