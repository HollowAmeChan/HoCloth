...
class HOCLOTH_PT_main_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        settings_col.prop(scene, "hocloth_max_simulation_steps_per_frame", text="Max Steps / Frame")
        ...
        runtime_box.label(text=f"Last Skipped Steps: {getattr(scene, 'hocloth_runtime_last_skipped_steps', 0)}")
